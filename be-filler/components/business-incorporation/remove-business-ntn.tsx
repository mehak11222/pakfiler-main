...
interface Step2RemoveBusinessNtnProps {
    formData: any;
...
export const Step2RemoveBusinessNtn = ({
    formData,
    updateFormData,
    handleBack,
    handleSubmit,
}: Step2RemoveBusinessNtnProps) => {
    ...
    return (
        <form className="space-y-6">
            ...
            <div className="space-y-2">
                <Label className="text-gray-700 font-medium">Cessation Date</Label>
                <Input
                    type="date"
                    name="cessationDate"
